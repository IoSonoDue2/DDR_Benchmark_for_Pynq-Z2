...
$(ObjDir)/ddrbenchmark2_testbench.cpp_pre.cpp.tb.o : ddrbenchmark2_testbench.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ddrbenchmark2_testbench.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/ddrbenchmark2.cpp_pre.cpp.tb.o : ddrbenchmark2.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ddrbenchmark2.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
