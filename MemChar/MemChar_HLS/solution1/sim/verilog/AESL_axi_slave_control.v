...
//------------------------Parameter----------------------
`define TV_IN_input_r "../tv/cdatafile/c.ddrbenchmark2.autotvin_input_r.dat"
`define TV_IN_output_r "../tv/cdatafile/c.ddrbenchmark2.autotvin_output_r.dat"
...
parameter ddrbenchmark2_continue_addr = 0;
parameter ddrbenchmark2_auto_start_addr = 0;
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        ...
        if (write_start_count >= 101) begin
            write_start_run_flag <= 0; 
        end
