...
`define AUTOTB_DUT      ddrbenchmark2
`define AUTOTB_DUT_INST AESL_inst_ddrbenchmark2
`define AUTOTB_TOP      apatb_ddrbenchmark2_top
`define AUTOTB_LAT_RESULT_FILE "ddrbenchmark2.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "ddrbenchmark2.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_ddrbenchmark2_top
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.ddrbenchmark2.autotvin_gmem.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.ddrbenchmark2.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "../tv/rtldatafile/rtl.ddrbenchmark2.autotvin_output_r.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.ddrbenchmark2.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.ddrbenchmark2.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 101;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1017;
parameter LENGTH_input_r = 1;
parameter LENGTH_output_r = 1;
parameter LENGTH_gmem = 2000;
