...
if {[file isfile ddrbenchmark2.autotvin.dat]} {
	file delete -force ddrbenchmark2.autotvin.dat
}

if {[file isfile ddrbenchmark2.autotvout.dat]} {
	file delete -force ddrbenchmark2.autotvout.dat
}
