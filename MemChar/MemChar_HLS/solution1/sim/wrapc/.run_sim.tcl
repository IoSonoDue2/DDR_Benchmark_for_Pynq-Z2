...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ddrbenchmark2.autotvin.dat"
	set constFileTvOut       "ddrbenchmark2.autotvout.dat"
	set constFileHdlTvIn     "ddrbenchmark2.autohdltvin.dat"
	set constFileHdlTvOut    "ddrbenchmark2.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
