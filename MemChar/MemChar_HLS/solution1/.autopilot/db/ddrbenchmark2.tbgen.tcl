...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"ddrbenchmark2","role":"start","value":"0","valid_bit":"0"},{"name":"ddrbenchmark2","role":"continue","value":"0","valid_bit":"4"},{"name":"ddrbenchmark2","role":"auto_start","value":"0","valid_bit":"7"},{"name":"input_r","role":"data","value":"16"},{"name":"output_r","role":"data","value":"28"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"ddrbenchmark2","role":"start","value":"0","valid_bit":"0"},{"name":"ddrbenchmark2","role":"done","value":"0","valid_bit":"1"},{"name":"ddrbenchmark2","role":"idle","value":"0","valid_bit":"2"},{"name":"ddrbenchmark2","role":"ready","value":"0","valid_bit":"3"},{"name":"ddrbenchmark2","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "4"],
		...
		"Port" : [
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "IO",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_ddrbenchmark2_Pipeline_access_fu_85", "Port" : "gmem", "Inst_start_state" : "9", "Inst_end_state" : "10"}]},
			{"Name" : "input_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "output_r", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_ddrbenchmark2_Pipeline_access_fu_85", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "ddrbenchmark2_Pipeline_access",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		...
		"Port" : [
			...
			{"Name" : "sext_ln15_1", "Type" : "None", "Direction" : "I"},
			{"Name" : "sext_ln15", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
			{"Name" : "access", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ddrbenchmark2_Pipeline_access_fu_85.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
...
set ArgLastReadFirstWriteLatency {
	ddrbenchmark2 {
		gmem {Type IO LastRead 10 FirstWrite 2}
		input_r {Type I LastRead 0 FirstWrite -1}
		output_r {Type I LastRead 0 FirstWrite -1}}
	ddrbenchmark2_Pipeline_access {
		gmem {Type IO LastRead 1 FirstWrite 2}
		sext_ln15_1 {Type I LastRead 0 FirstWrite -1}
		sext_ln15 {Type I LastRead 0 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1017", "Max" : "1017"}
	, {"Name" : "Interval", "Min" : "1018", "Max" : "1018"}
]}
