set moduleName ddrbenchmark2_Pipeline_access
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {ddrbenchmark2_Pipeline_access}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 64 regular {axi_master 2}  }
	{ sext_ln15_1 int 61 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln15_1", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln15_1 sc_in sc_lv 61 signal 1 } 
	{ sext_ln15 sc_in sc_lv 61 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln15_1", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln15_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln15_1 { ap_none {  { sext_ln15_1 in_data 0 61 } } }
