...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.ddrbenchmark2.autotvin_input_r.dat"
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.ddrbenchmark2.autotvout_input_r.dat"
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.ddrbenchmark2.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.ddrbenchmark2.autotvout_output_r.dat"
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.ddrbenchmark2.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.ddrbenchmark2.autotvout_gmem.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_input_r "../tv/rtldatafile/rtl.ddrbenchmark2.autotvout_input_r.dat"
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.ddrbenchmark2.autotvout_output_r.dat"
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.ddrbenchmark2.autotvout_gmem.dat"
...
extern "C" void ddrbenchmark2_hw_stub_wrapper(volatile void *, volatile void *);
...
{
transaction<64> tr(2000);
aesl_fh.read(AUTOTB_TVOUT_PC_gmem, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<8>((char*)__xlx_apatb_param_input_r, 1000, 0);
tr.send<8>((char*)__xlx_apatb_param_output_r, 1000, 1000);
}
#else
try {
static PostCheck<64> pc(AUTOTB_TVOUT_PC_gmem);
pc.psize = 8;
pc.param = (char*)__xlx_apatb_param_input_r;
pc.depth = 1000;
pc.run(AESL_transaction_pc, 0);pc.param = (char*)__xlx_apatb_param_output_r;
pc.depth = 1000;
...
transaction<64> tr(2000);
__xlx_offset_byte_param_input_r = 0*8;
if (__xlx_apatb_param_input_r) {
  tr.import<8>((char*)__xlx_apatb_param_input_r, 1000, 0);
}
__xlx_offset_byte_param_output_r = 1000*8;
if (__xlx_apatb_param_output_r) {
  tr.import<8>((char*)__xlx_apatb_param_output_r, 1000, 0);
}
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_input_r + i * 8;
...
ddrbenchmark2_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r);
