La funzione prende in ingresso 2 array di int 512bit, uno di innput ed uno di output, scrive in memoria l'array di input e lo rilegge per poterlo mandare in output.
