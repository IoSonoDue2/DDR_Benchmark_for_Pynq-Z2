...
HD_PWD='/home/due2/Desktop/FPGAs/MemChar/MemChar_bitstream/MemChar_bitstream.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Memory_Char_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Memory_Char_wrapper.tcl -notrace
