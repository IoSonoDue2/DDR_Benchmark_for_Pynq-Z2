...
HD_PWD='/home/due2/Desktop/FPGAs/MemChar/MemChar_bitstream/MemChar_bitstream.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Memory_Char_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Memory_Char_wrapper.tcl
